...
const PROJECTS = [
  {
    title: "Project CORE",
    description: "Modular embedded audio digital signal processing system. Authored low latency C++ callbacks for high fidelity audio processing.",
    img: "/images/pic01.jpg"
  },
  {
    title: "Catalyst Cloud Burn Tracker",
    description: "Financial alerting pipeline for startups integrating Plaid and Gmail with Gemini backend.",
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-white selection:text-black">
      <nav className="max-w-6xl mx-auto px-8 py-8 flex justify-between items-center">
        <span className="text-xl font-bold tracking-tighter uppercase">Justin Allen</span>
      ...
      <main className="max-w-4xl mx-auto px-8 py-24">
        ...
        <header className="mb-32">
          <h1 className="text-7xl font-bold mb-8 tracking-tighter leading-none">Justin Allen</h1>
          ...
          <div className="flex gap-6">
            <a href="#" className="border-b border-white pb-1 text-sm hover:opacity-70 transition-opacity">LinkedIn</a>
            <a href="#" className="border-b border-white pb-1 text-sm hover:opacity-70 transition-opacity">GitHub</a>
          </div>
        </header>

        {/* ABOUT */}
        <section id="about" className="mb-32">
          <h2 className="text-sm uppercase tracking-widest text-zinc-500 mb-8">About</h2>
          <p className="text-xl leading-relaxed text-zinc-300 max-w-2xl">
            I am a Computer Science student at Georgia Tech focusing on Cybersecurity and Information Internetworks. 
            My work centers on embedded systems and low level optimization.
          </p>
        </section>

        {/* EXPERIENCE */}
        <section className="mb-32">
          <h2 className="text-sm uppercase tracking-widest text-zinc-500 mb-12">Experience</h2>
        ...
        {/* PROJECTS */}
        <section id="projects">
          <h2 className="text-sm uppercase tracking-widest text-zinc-500 mb-12">Core Projects</h2>
          <div className="grid gap-16">
            {PROJECTS.map((proj, i) => (
              <div key={i} className="group">
                <div className="bg-zinc-900 aspect-video w-full rounded-sm mb-6 overflow-hidden relative">
                ...
                <a href="#" className="text-sm border-b border-white pb-1 hover:opacity-70 transition-opacity">View Project</a>
              </div>
            ))}
          </div>
        </section>
